...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2hpc2hpcmJrIiwiYSI6ImNsOWZkYnV6dzAyNHIzdXA5Mncxa2NrejcifQ.2DAayLd5GsKY4JUeSjNDhw';
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51LxAHVHgJIvqnH7C53DTUg6j1NCVh7KCyFLM4aUoJmJewGdSHgbFGvybDYyx0p0KgGpFIeKyXercvY8YyZVkRR1z00B6CfUzgE');
            _context.prev = 1;
            _context.next = 4;
